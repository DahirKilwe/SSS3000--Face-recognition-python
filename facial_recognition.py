...
LATITUDE = 59.892266 # 🔹 Replace with your exact latitude
LONGITUDE = 10.525244  # 🔹 Replace with your exact longitude
...
def process_frame(frame):
    ...
    for face_encoding in face_encodings:
        ...
        if denied_by_police:
            ...
            status_message = "⚠️ 18+ Tillatt - Ingen Alkohol Over 22%"
...
def draw_results(frame, status_message, status_color, face_data):
    ...
    status_font = ImageFont.truetype(font_path, 50)
    name_font = ImageFont.truetype(font_path, 40)  # Font for name and age
